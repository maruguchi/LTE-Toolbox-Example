classdef lteMaxCIscheduler < handle
    ...
    methods
        %%
        function obj = lteMaxCIscheduler()
            % MaxCI Scheduler constructor
            %   obj = lteMaxCIscheduler()
            %
        ...
        function [] = addSDU (obj, ueIn, sdu)
            ...
            % add UE of the SDU into Max CI register
        ...
        function [tb, ueMon] = schedule (obj, enb)
            ...
            % sort UE based on CQI this turn 
            % this used as UE preferences from most to least preferred
            [~, Idx] = sort([obj.ue.cqi], 'descend');
            obj.ue = obj.ue(Idx);
            turnIdx = 1;
            ueServ = 0;
            ueNo = length(obj.ue);
