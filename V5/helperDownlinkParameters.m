% Matlab code for downlink parameter settings helper script
...
%% Shared Channel parameter settings

% adding DTCH downlink transmission

% sharedChannelBuilder(enb, type, allocationType, rnti, vrbStart, vrbLength, mcs, rv)

[sharedChannel(1), userChannel(1)] = sharedChannelBuilder(enb,'Downlink-DTCH',2,100,0,6,mcs,0);
