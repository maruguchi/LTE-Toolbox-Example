...
iterationNumber  = 100;                 % number of subframes calculated for each point of SNR
...
%                     
            ...
            for NSubframe = 0:9
                ...
                if ~(mod(NSubframe,5) == 0)
                    ...
                    [trblkout,err,stateout]  = lteDLSCHDecode(enb,pdsch,tbs,pdschRxSoftBits);
    ...
    save('1st_transc.mat','crcBER','BLER','dataerr','SNRpad')
end
